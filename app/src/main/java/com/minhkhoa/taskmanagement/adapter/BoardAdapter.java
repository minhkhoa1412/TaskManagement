...
public class BoardAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Picasso.get().load(boardArrayList.get(position).getBoardImage()).into(viewHolder.imgSmall);
        Picasso.get().load(boardArrayList.get(position).getBoardImage()).into(viewHolder.imgLarge);
